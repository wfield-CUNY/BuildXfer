...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty.js */ \"./node_modules/@babel/runtime/helpers/esm/defineProperty.js\");\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.runtime.esm.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"].extend({\n  name: 'mouse',\n  methods: {\n    getDefaultMouseEventHandlers: function getDefaultMouseEventHandlers(suffix, getEvent) {\n      var _this$getMouseEventHa;\n\n      return this.getMouseEventHandlers((_this$getMouseEventHa = {}, Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'click' + suffix, {\n        event: 'click'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'contextmenu' + suffix, {\n        event: 'contextmenu',\n        prevent: true,\n        result: false\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'mousedown' + suffix, {\n        event: 'mousedown'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'mousemove' + suffix, {\n        event: 'mousemove'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'mouseup' + suffix, {\n        event: 'mouseup'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'mouseenter' + suffix, {\n        event: 'mouseenter'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'mouseleave' + suffix, {\n        event: 'mouseleave'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'touchstart' + suffix, {\n        event: 'touchstart'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'touchmove' + suffix, {\n        event: 'touchmove'\n      }), Object(C_Users_wfield_Documents_Projects_PA_Redistricting_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_this$getMouseEventHa, 'touchend' + suffix, {\n        event: 'touchend'\n      }), _this$getMouseEventHa), getEvent);\n    },\n    getMouseEventHandlers: function getMouseEventHandlers(events, getEvent) {\n      var _this = this;\n\n      var on = {};\n\n      var _loop = function _loop(event) {\n        var eventOptions = events[event];\n        if (!_this.$listeners[event]) return \"continue\"; // TODO somehow pull in modifiers\n\n        var prefix = eventOptions.passive ? '&' : (eventOptions.once ? '~' : '') + (eventOptions.capture ? '!' : '');\n        var key = prefix + eventOptions.event;\n\n        var handler = function handler(e) {\n          var mouseEvent = e;\n\n          if (eventOptions.button === undefined || mouseEvent.buttons > 0 && mouseEvent.button === eventOptions.button) {\n            if (eventOptions.prevent) {\n              e.preventDefault();\n            }\n\n            if (eventOptions.stop) {\n              e.stopPropagation();\n            } // Due to TouchEvent target always returns the element that is first placed\n            // Even if touch point has since moved outside the interactive area of that element\n            // Ref: https://developer.mozilla.org/en-US/docs/Web/API/Touch/target\n            // This block of code aims to make sure touchEvent is always dispatched from the element that is being pointed at\n\n\n            if (e && 'touches' in e) {\n              var _e$target, _e$target2;\n\n              var currentTarget = document.elementFromPoint(e.changedTouches[0].clientX, e.changedTouches[0].clientY);\n\n              if (currentTarget && !((_e$target = e.target) != null && _e$target.isSameNode(currentTarget)) && ((_e$target2 = e.target) == null ? void 0 : _e$target2.className) === currentTarget.className) {\n                currentTarget.dispatchEvent(new TouchEvent(e.type, {\n                  changedTouches: e.changedTouches,\n                  targetTouches: e.targetTouches,\n                  touches: e.touches\n                }));\n                return;\n              }\n            }\n\n            _this.$emit(event, getEvent(e), e);\n          }\n\n          return eventOptions.result;\n        };\n\n        if (key in on) {\n          /* istanbul ignore next */\n          if (Array.isArray(on[key])) {\n            on[key].push(handler);\n          } else {\n            on[key] = [on[key], handler];\n          }\n        } else {\n          on[key] = handler;\n        }\n      };\n\n      for (var event in events) {\n        var _ret = _loop(event);\n\n        if (_ret === \"continue\") continue;\n      }\n\n      return on;\n    }\n  }\n}));\n\n//# sourceURL=webpack:///./node_modules/vuetify/lib/components/VCalendar/mixins/mouse.js?");
